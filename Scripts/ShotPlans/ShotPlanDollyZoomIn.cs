using UnityEngine;
public class ShotPlanDollyZoomIn : ShotPlan
{
    public int dollyEndFOV;
    public float dollyEndDistance;
    public ShotPlanDollyZoomIn(int id, int environmentType, int fps, float duration, int FOV, ShotTypes shotType,

...
public class ShotPlanPanRight : ShotPlan
{
    public int panDegrees;
    public float panHeight;
    public ShotPlanPanRight(int id, int environmentType, int fps, float duration, int FOV, ShotTypes shotType,
